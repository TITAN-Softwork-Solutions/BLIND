...
namespace IX_RUNTIME_INTERNAL
{
    ...
    template <std::size_t N> IxScopedAnsiLiteral(const IxEncodedAnsiLiteral<N> &literal) -> IxScopedAnsiLiteral<N>;

    template <std::size_t N> IxScopedWideLiteral(const IxEncodedWideLiteral<N> &literal) -> IxScopedWideLiteral<N>;
